...
ServerLobbyOrder::ServerLobbyOrder(const uint8_t &code, const size_t &clientId)
    : ServerLobbyOrder(code, clientId, DEFAULT_GAME_NAME, DEFAULT_GAME_MAP_TYPE,
                       DEFAULT_PLAYER_COUNT, DEFAULT_ROUND_COUNT) {}

ServerLobbyOrder::ServerLobbyOrder(const uint8_t &code, const size_t &clientId,
                                   const std::string &gameName)
    : ServerLobbyOrder(code, clientId, gameName, DEFAULT_GAME_MAP_TYPE,
                       DEFAULT_PLAYER_COUNT, DEFAULT_ROUND_COUNT) {}

ServerLobbyOrder::ServerLobbyOrder(const uint8_t &code, const size_t &clientId,
                                   const std::string &gameName,
                                   const uint8_t &gameMapType,
                                   const uint8_t &playerCount,
                                   const uint8_t &roundCount)
    : clientId(clientId), gameName(gameName), mapType(gameMapType),
      playerCount(playerCount), roundCount(roundCount) {

  orderTranslator = {{ProtocolConstants::GAME_LIST_REQUEST, LOBBY_LIST},
  ...
  mapTypeTranslator = {{MapConstants::DUST, MapType::DUST},
...
ServerLobbyOrder::ServerLobbyOrder(ServerLobbyOrder &&other) noexcept
    : orderType(other.orderType), clientId(other.clientId),
      gameName(std::move(other.gameName)), mapType(other.mapType),
      playerCount(other.playerCount), roundCount(other.roundCount),
...
const size_t &ServerLobbyOrder::getClientId() const { return this->clientId; }

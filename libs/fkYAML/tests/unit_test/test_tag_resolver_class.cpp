...
TEST_CASE("TagResolver_ResolveTag") {
    ...
    SECTION("valid tag name with default tag handle prefixes") {
        ...
        REQUIRE_NOTHROW(tag_type = fkyaml::detail::tag_resolver<fkyaml::node>::resolve_tag(
                                test_pair.first, directives));
    ...
    SECTION("valid tag name with non-default primary handle prefix") {
        ...
        auto test_pair = GENERATE(test_pair_t{"!str", fkyaml::detail::tag_t::CUSTOM_TAG},
    ...
    SECTION("valid tag name with non-default secondary handle prefix") {
        ...
        auto test_pair = GENERATE(test_pair_t{"!!seq", fkyaml::detail::tag_t::CUSTOM_TAG},
    ...
    SECTION("valid tag name with named handles") {
        ...
        auto test_pair =
                GENERATE(test_pair_t{"!yaml!seq", fkyaml::detail::tag_t::SEQUENCE},
    ...
    SECTION("invalid tag name with empty document_metainfo<fkyaml::node>") {
        auto tag = GENERATE(fkyaml::detail::str_view(""), fkyaml::detail::str_view("invalid"),
                            fkyaml::detail::str_view("!invalid!tag"));

        REQUIRE_THROWS_AS(fkyaml::detail::tag_resolver<fkyaml::node>::resolve_tag(tag, directives),
                          fkyaml::invalid_tag);
    }

...
TEST(SpawnTest, Check) {
    ...
    Coordinate playerActualPosition(playerInfo.getCoordinate().getX(),
...
TEST(CollisionTest, Check) {
    ...
    Coordinate actualPosition(juanPlayerInfo.getCoordinate().getX(),
                              juanPlayerInfo.getCoordinate().getY());

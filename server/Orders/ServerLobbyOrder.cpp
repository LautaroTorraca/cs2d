...
ServerLobbyOrder::ServerLobbyOrder(const uint8_t& code, const size_t& clientId,
        ...
        ServerLobbyOrder(code, clientId, gameName, DEFAULT_GAME_MAP_TYPE, DEFAULT_PLAYER_COUNT,
                         DEFAULT_ROUND_COUNT) {}
...
const std::string& ServerLobbyOrder::getGameName() const { return this->gameName; }
...
const uint8_t& ServerLobbyOrder::getPlayerCount() const { return this->playerCount; }

const uint8_t& ServerLobbyOrder::getRoundCount() const { return this->roundCount; }

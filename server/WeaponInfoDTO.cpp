...
WeaponInfoDTO::WeaponInfoDTO(WeaponInfoDTO&& other) noexcept:
        ammoAmount(other.ammoAmount), weaponType(other.weaponType) {
    if (this != &other) {
        other.ammoAmount = 0;
...
const uint16_t& WeaponInfoDTO::getAmmoAmount() const { return this->ammoAmount; }

const WeaponType& WeaponInfoDTO::getWeaponType() const { return this->weaponType; }

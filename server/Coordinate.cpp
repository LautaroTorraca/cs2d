...
uint32_t Coordinate::addingX(const uint32_t& x) const { return this->x + x; }

uint32_t Coordinate::addingY(const uint32_t& y) const { return this->y + y; }
...
CoordinateDTO Coordinate::getInfo() const { return {this->x, this->y}; }

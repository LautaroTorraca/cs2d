...
TEST_CASE("NodeAttrs_GetAnchorOffset") {
    ...
    auto test_data = GENERATE(test_data_t{0, 0}, test_data_t{0xA0000000u, 0x28u},
                              test_data_t{0xFC000000u, 0x3Fu});
...
TEST_CASE("NodeAttrs_SetAnchorOffset") {
    ...
    auto test_data = GENERATE(test_data_t{0, 0}, test_data_t{0x28u, 0xA0000000u},
                              test_data_t{0x3Fu, 0xFC000000u});

...
TEST_CASE("InputAdapter_IteratorInputAdapterProvider") {
    ...
    SECTION("C-style char array") {
        ...
        REQUIRE(std::is_same<decltype(input_adapter),
                             fkyaml::detail::iterator_input_adapter<char*>>::value);
    }
    ...
    SECTION("C-style char8_t array") {
        ...
        REQUIRE(std::is_same<decltype(input_adapter),
                             fkyaml::detail::iterator_input_adapter<char8_t*>>::value);
    }
#endif
    ...
    SECTION("C-style char16_t array") {
        ...
        REQUIRE(std::is_same<decltype(input_adapter),
                             fkyaml::detail::iterator_input_adapter<char16_t*>>::value);
    }
    ...
    SECTION("C-style char32_t array") {
        ...
        REQUIRE(std::is_same<decltype(input_adapter),
                             fkyaml::detail::iterator_input_adapter<char32_t*>>::value);
    }
    ...
    SECTION("std::string") {
        ...
        REQUIRE(std::is_same<decltype(input_adapter),
                             fkyaml::detail::iterator_input_adapter<iterator_type>>::value);
    }
...
TEST_CASE("InputAdapter_GetBufferView_UTF8N") {
    ...
    SECTION("iterator_input_adapter with std::string") {
        ...
        REQUIRE(std::is_same<decltype(input_adapter),
                             fkyaml::detail::iterator_input_adapter<itr_type>>::value);
...
TEST_CASE("InputAdapter_GetBufferView_UTF8BOM") {
    SECTION("iterator_input_adapter with a char array") {
        char input[] = {char(0xEFu), char(0xBBu), char(0xBFu), 't', 'e', 's', 't', ' ',
                        's',         'o',         'u',         'r', 'c', 'e', '.', 0};
        auto input_adapter = fkyaml::detail::input_adapter(input);
        REQUIRE(std::is_same<decltype(input_adapter),
                             fkyaml::detail::iterator_input_adapter<char*>>::value);
    ...
    SECTION("iterator_input_adapter with std::string") {
        char raw_input[] = {char(0xEFu), char(0xBBu), char(0xBFu), 't', 'e', 's', 't', ' ',
                            's',         'o',         'u',         'r', 'c', 'e', '.', 0};
...
TEST_CASE("InputAdapter_GetBufferView_UTF16BEN") {
    ...
    SECTION("iterator_input_adapter with std::string") {
        std::string input{0,           0x61, 0x30, 0x42, char(0xD8u), 0x40,
                          char(0xDCu), 0x0B, 0,    0x52, 0,           0x5A};
        auto input_adapter = fkyaml::detail::input_adapter(input);
        using itr_type = typename std::string::const_iterator;
        REQUIRE(std::is_same<decltype(input_adapter),
                             fkyaml::detail::iterator_input_adapter<itr_type>>::value);
...
TEST_CASE("InputAdapter_GetBufferView_UTF16BEBOM") {
    SECTION("iterator_input_adapter with a char array") {
        char input[] = {char(0xFEu), char(0xFFu), 0,    0x61, 0x30, 0x42, char(0xD8u),
                        0x40,        char(0xDCu), 0x0B, 0,    0x52, 0};
        auto input_adapter = fkyaml::detail::input_adapter(input);
        REQUIRE(std::is_same<decltype(input_adapter),
                             fkyaml::detail::iterator_input_adapter<char*>>::value);
    ...
    SECTION("iterator_input_adapter with std::string") {
        std::string input{char(0xFEu), char(0xFFu), 0,           0x61, 0x30, 0x42,
                          char(0xD8u), 0x40,        char(0xDCu), 0x0B, 0,    0x52};
        auto input_adapter = fkyaml::detail::input_adapter(input);
        using itr_type = typename std::string::const_iterator;
        REQUIRE(std::is_same<decltype(input_adapter),
                             fkyaml::detail::iterator_input_adapter<itr_type>>::value);
...
TEST_CASE("InputAdapter_GetBufferView_UTF16LEBOM") {
    SECTION("iterator_input_adapter with a char array") {
        char input[] = {char(0xFFu), char(0xFEu), 0x61,        0,    0x42, 0x30, 0x40,
                        char(0xD8u), 0x0B,        char(0xDCu), 0x52, 0,    0};
        auto input_adapter = fkyaml::detail::input_adapter(input);
        REQUIRE(std::is_same<decltype(input_adapter),
                             fkyaml::detail::iterator_input_adapter<char*>>::value);
    ...
    SECTION("iterator_input_adapter with std::string") {
        std::string input{char(0xFFu), char(0xFEu), 0x61, 0,           0x42, 0x30,
                          0x40,        char(0xD8u), 0x0B, char(0xDCu), 0x52, 0};
        auto input_adapter = fkyaml::detail::input_adapter(input);
        using itr_type = typename std::string::const_iterator;
        REQUIRE(std::is_same<decltype(input_adapter),
                             fkyaml::detail::iterator_input_adapter<itr_type>>::value);
...
TEST_CASE("InputAdapter_GetBufferView_UTF32BEBOM") {
    SECTION("iterator_input_adapter with a char array") {
        char input[] = {0, 0,    char(0xFEu), char(0xFFu), 0,    0, 0,    0x61, 0,
                        0, 0x30, 0x42,        0,           0x02, 0, 0x0B, 0};
        auto input_adapter = fkyaml::detail::input_adapter(input);
        REQUIRE(std::is_same<decltype(input_adapter),
                             fkyaml::detail::iterator_input_adapter<char*>>::value);
    ...
    SECTION("iterator_input_adapter with std::string") {
        std::string input{0, 0, char(0xFEu), char(0xFFu), 0, 0,    0, 0x61,
                          0, 0, 0x30,        0x42,        0, 0x02, 0, 0x0B};
        auto input_adapter = fkyaml::detail::input_adapter(input);
        using itr_type = typename std::string::const_iterator;
        REQUIRE(std::is_same<decltype(input_adapter),
                             fkyaml::detail::iterator_input_adapter<itr_type>>::value);
...
TEST_CASE("InputAdapter_GetBufferView_UTF32LEBOM") {
    SECTION("iterator_input_adapter with a char array") {
        char input[] = {char(0xFFu), char(0xFEu), 0, 0,    0x61, 0,    0, 0, 0x42,
                        0x30,        0,           0, 0x0B, 0,    0x02, 0, 0};
        auto input_adapter = fkyaml::detail::input_adapter(input);
        REQUIRE(std::is_same<decltype(input_adapter),
                             fkyaml::detail::iterator_input_adapter<char*>>::value);
    ...
    SECTION("iterator_input_adapter with std::string") {
        std::string input{char(0xFFu), char(0xFEu), 0, 0, 0x61, 0, 0,    0,
                          0x42,        0x30,        0, 0, 0x0B, 0, 0x02, 0};
        auto input_adapter = fkyaml::detail::input_adapter(input);
        using itr_type = typename std::string::const_iterator;
        REQUIRE(std::is_same<decltype(input_adapter),
                             fkyaml::detail::iterator_input_adapter<itr_type>>::value);
...
TEST_CASE("InputAdapter_GetBufferView_UTF8CharsValidation") {
    ...
    SECTION("file_input_adapter with valid 1-byte UTF-8 encodings") {
        DISABLE_C4996
        FILE* p_file = std::fopen(
                FK_YAML_TEST_DATA_DIR "/input_adapter_test_data_utf8n_valid_1byte_char.txt", "r");
        ENABLE_C4996
    ...
    SECTION("file_input_adapter with invalid 1-byte UTF-8 encodings") {
        DISABLE_C4996
        FILE* p_file = std::fopen(
                FK_YAML_TEST_DATA_DIR "/input_adapter_test_data_utf8n_invalid_1byte_char.txt", "r");
        ENABLE_C4996
    ...
    SECTION("stream_input_adapter with valid 1-byte UTF-8 encodings") {
        std::ifstream ifs(FK_YAML_TEST_DATA_DIR
                          "/input_adapter_test_data_utf8n_valid_1byte_char.txt");
        auto input_adapter = fkyaml::detail::input_adapter(ifs);
        REQUIRE(std::is_same<decltype(input_adapter), fkyaml::detail::stream_input_adapter>::value);
    ...
    SECTION("stream_input_adapter with invalid 1-byte UTF-8 encodings") {
        std::ifstream ifs(FK_YAML_TEST_DATA_DIR
                          "/input_adapter_test_data_utf8n_invalid_1byte_char.txt");
        auto input_adapter = fkyaml::detail::input_adapter(ifs);
        REQUIRE(std::is_same<decltype(input_adapter), fkyaml::detail::stream_input_adapter>::value);
    ...
    SECTION("file_input_adapter with valid 2-byte UTF-8 encodings") {
        DISABLE_C4996
        FILE* p_file = std::fopen(
                FK_YAML_TEST_DATA_DIR "/input_adapter_test_data_utf8n_valid_2byte_char.txt", "r");
        ENABLE_C4996
    ...
    SECTION("file_input_adapter with invalid 2-byte UTF-8 encodings") {
        DISABLE_C4996
        FILE* p_file = std::fopen(
                FK_YAML_TEST_DATA_DIR "/input_adapter_test_data_utf8n_invalid_2byte_char.txt", "r");
        ENABLE_C4996
    ...
    SECTION("stream_input_adapter with valid 2-byte UTF-8 encodings") {
        std::ifstream ifs(FK_YAML_TEST_DATA_DIR
                          "/input_adapter_test_data_utf8n_valid_2byte_char.txt");
        auto input_adapter = fkyaml::detail::input_adapter(ifs);
        REQUIRE(std::is_same<decltype(input_adapter), fkyaml::detail::stream_input_adapter>::value);
    ...
    SECTION("stream_input_adapter with invalid 2-byte UTF-8 encodings") {
        std::ifstream ifs(FK_YAML_TEST_DATA_DIR
                          "/input_adapter_test_data_utf8n_invalid_2byte_char.txt");
        auto input_adapter = fkyaml::detail::input_adapter(ifs);
        REQUIRE(std::is_same<decltype(input_adapter), fkyaml::detail::stream_input_adapter>::value);
    ...
    SECTION("iterator_input_adapter with valid 3-byte UTF-8 encodings") {
        char input[] = {
                char(0xE0u), char(0x80u), char(0x80u), char(0xECu), char(0xBFu), char(0xBFu), 0};
        auto input_adapter = fkyaml::detail::input_adapter(input);
        REQUIRE(std::is_same<decltype(input_adapter),
                             fkyaml::detail::iterator_input_adapter<char*>>::value);
    ...
    SECTION("file_input_adapter with valid 3-byte UTF-8 encodings") {
        DISABLE_C4996
        FILE* p_file = std::fopen(
                FK_YAML_TEST_DATA_DIR "/input_adapter_test_data_utf8n_valid_3byte_char.txt", "r");
        ENABLE_C4996
    ...
    SECTION("file_input_adapter with invalid 3-byte UTF-8 encodings") {
        DISABLE_C4996
        FILE* p_file = std::fopen(
                FK_YAML_TEST_DATA_DIR "/input_adapter_test_data_utf8n_invalid_3byte_char.txt", "r");
        ENABLE_C4996
    ...
    SECTION("stream_input_adapter with valid 3-byte UTF-8 encodings") {
        std::ifstream ifs(FK_YAML_TEST_DATA_DIR
                          "/input_adapter_test_data_utf8n_valid_3byte_char.txt");
        auto input_adapter = fkyaml::detail::input_adapter(ifs);
        REQUIRE(std::is_same<decltype(input_adapter), fkyaml::detail::stream_input_adapter>::value);
    ...
    SECTION("stream_input_adapter with invalid 3-byte UTF-8 encodings") {
        std::ifstream ifs(FK_YAML_TEST_DATA_DIR
                          "/input_adapter_test_data_utf8n_invalid_3byte_char.txt");
        auto input_adapter = fkyaml::detail::input_adapter(ifs);
        REQUIRE(std::is_same<decltype(input_adapter), fkyaml::detail::stream_input_adapter>::value);
    ...
    SECTION("iterator_input_adapter with valid 4-byte UTF-8 encodings") {
        char input[] = {char(0xF0u), char(0x90u), char(0x80u),
                        char(0x80u), char(0xF2u), char(0xBFu),
                        char(0x80u), char(0x80u), 0};
        auto input_adapter = fkyaml::detail::input_adapter(input);
        REQUIRE(std::is_same<decltype(input_adapter),
                             fkyaml::detail::iterator_input_adapter<char*>>::value);
    ...
    SECTION("iterator_input_adapter with invalid 4-byte UTF-8 encodings") {
        char input[] = {char(0xF0u), char(0x80u), 0x70,        0x70,
                        char(0xF4u), char(0xC0u), char(0xC0u), 0};
        auto input_adapter = fkyaml::detail::input_adapter(input);
        REQUIRE(std::is_same<decltype(input_adapter),
                             fkyaml::detail::iterator_input_adapter<char*>>::value);
    ...
    SECTION("file_input_adapter with valid 4-byte UTF-8 encodings") {
        DISABLE_C4996
        FILE* p_file = std::fopen(
                FK_YAML_TEST_DATA_DIR "/input_adapter_test_data_utf8n_valid_4byte_char.txt", "r");
        ENABLE_C4996
    ...
    SECTION("file_input_adapter with invalid 4-byte UTF-8 encodings") {
        DISABLE_C4996
        FILE* p_file = std::fopen(
                FK_YAML_TEST_DATA_DIR "/input_adapter_test_data_utf8n_invalid_4byte_char.txt", "r");
        ENABLE_C4996
    ...
    SECTION("stream_input_adapter with valid 4-byte UTF-8 encodings") {
        std::ifstream ifs(FK_YAML_TEST_DATA_DIR
                          "/input_adapter_test_data_utf8n_valid_4byte_char.txt");
        auto input_adapter = fkyaml::detail::input_adapter(ifs);
        REQUIRE(std::is_same<decltype(input_adapter), fkyaml::detail::stream_input_adapter>::value);
    ...
    SECTION("stream_input_adapter with invalid 4-byte UTF-8 encodings") {
        std::ifstream ifs(FK_YAML_TEST_DATA_DIR
                          "/input_adapter_test_data_utf8n_invalid_4byte_char.txt");
        auto input_adapter = fkyaml::detail::input_adapter(ifs);
        REQUIRE(std::is_same<decltype(input_adapter), fkyaml::detail::stream_input_adapter>::value);
...
TEST_CASE("InputAdapter_GetBufferView_UTF8NewlineCodeNormalization") {
    ...
    SECTION("file_input_adapter") {
        DISABLE_C4996
        FILE* p_file =
                std::fopen(FK_YAML_TEST_DATA_DIR "/input_adapter_test_data_utf8_crlf.txt", "r");
        ENABLE_C4996
...
TEST_CASE("InputAdapter_GetBufferView_UTF16BENewlineCodeNormalization") {
    ...
    SECTION("iterator_input_adapter (char16_t)") {
        char16_t input[] = {0x0074u, 0x0065u, 0x0073u, 0x0074u, 0x000Du, 0x000Au, 0x0064u,
                            0x0061u, 0x0074u, 0x0061u, 0x000Du, 0x000Au, 0x0000};
        auto input_adapter = fkyaml::detail::input_adapter(input);
        REQUIRE(std::is_same<decltype(input_adapter),
                             fkyaml::detail::iterator_input_adapter<char16_t*>>::value);
    ...
    SECTION("file_input_adapter") {
        DISABLE_C4996
        FILE* p_file =
                std::fopen(FK_YAML_TEST_DATA_DIR "/input_adapter_test_data_utf16be_crlf.txt", "r");
        ENABLE_C4996
...
TEST_CASE("InputAdapter_GetBufferView_UTF32BENewlineCodeNormalization") {
    SECTION("iterator_input_adapter (char)") {
        char input[] = {0, 0,          0, char(0x74), 0, 0,          0, char(0x65), 0, 0,
                        0, char(0x73), 0, 0,          0, char(0x74), 0, 0,          0, char(0x0D),
                        0, 0,          0, char(0x0A), 0, 0,          0, char(0x64), 0, 0,
                        0, char(0x61), 0, 0,          0, char(0x74), 0, 0,          0, char(0x61),
                        0, 0,          0, char(0x0D), 0, 0,          0, char(0x0A), 0};
        auto input_adapter = fkyaml::detail::input_adapter(input);
        REQUIRE(std::is_same<decltype(input_adapter),
                             fkyaml::detail::iterator_input_adapter<char*>>::value);
    ...
    SECTION("iterator_input_adapter (char32_t)") {
        char32_t input[] = {0x00000074u, 0x00000065u, 0x00000073u, 0x00000074u, 0x0000000Du,
                            0x0000000Au, 0x00000064u, 0x00000061u, 0x00000074u, 0x00000061u,
                            0x0000000Du, 0x0000000Au, 0x00000000};
        auto input_adapter = fkyaml::detail::input_adapter(input);
        REQUIRE(std::is_same<decltype(input_adapter),
                             fkyaml::detail::iterator_input_adapter<char32_t*>>::value);
    ...
    SECTION("file_input_adapter") {
        DISABLE_C4996
        FILE* p_file =
                std::fopen(FK_YAML_TEST_DATA_DIR "/input_adapter_test_data_utf32be_crlf.txt", "r");
        ENABLE_C4996

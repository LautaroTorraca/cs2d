...
GameInfoParser::GameInfoParser(GameInfoParser &&other) noexcept : gameInfo(std::move(other.gameInfo)), playerInfo(std::move(other.playerInfo)), gameMapInfo(std::move(other.gameMapInfo)) {
    if (this !=& other) {

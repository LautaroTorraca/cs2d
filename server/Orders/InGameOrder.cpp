...
InGameOrder::InGameOrder(const uint8_t& code, const size_t& playerId, const uint16_t& ammoAmount,
                         const uint8_t& weaponInformation):
...
InGameOrder::InGameOrder(const uint8_t& code, const size_t& playerId, const uint16_t& direction,
        ...
        position(position) {
    orderTranslator = {{ProtocolConstants::PLAYER_MOVEMENT, IN_GAME_MOVE},
    ...
    toProduct = {{AK_47_WEAPON, AK_47_WEAPON},
                 {M3_WEAPON, M3_WEAPON},
    ...
    movementTranslator = {{UP_MOVEMENT, Movement::UP},
...
const OrderType& InGameOrder::getOrderType() const { return orderTranslator.at(this->orderType); }

const size_t& InGameOrder::getPlayerId() const { return this->playerId; }

const Movement& InGameOrder::getDirection() const {
    return this->movementTranslator.at(this->direction);
}

const uint16_t& InGameOrder::getAmount() const { return this->ammoAmount; }

const uint8_t& InGameOrder::getWeaponInformation() const { return this->weaponInformation; }

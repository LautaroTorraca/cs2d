...
void Knife::attack(Positionable& positionable, const Position& actualPosition,
                   const double& angle) {
    ...
    this->projectiles.emplace_back(std::make_shared<DirectProjectile>(
            positionable, actualPosition, direction, knifeRange, 1, knifeSpeed, damage));
}

...
TEST_CASE("ScalarParser_FlowPlainScalar_null") {
    ...
    SECTION("not tagged") {
        auto token = GENERATE(fkyaml::detail::str_view("null"), fkyaml::detail::str_view("Null"),
                              fkyaml::detail::str_view("NULL"), fkyaml::detail::str_view("~"));
...
TEST_CASE("ScalarParser_FlowPlainScalar_boolean") {
    ...
    SECTION("not tagged") {
        auto test_data = GENERATE(test_data_t("true", true), test_data_t("True", true),
                                  test_data_t("TRUE", true), test_data_t("false", false),
                                  test_data_t("False", false), test_data_t("FALSE", false));
...
TEST_CASE("ScalarParser_FlowPlainScalar_integer") {
    ...
    SECTION("not tagged") {
        auto test_data = GENERATE(test_data_t("123", 123), test_data_t("-123", -123),
                                  test_data_t("0", 0), test_data_t("+456", 456));
    ...
    SECTION("tagged") {
        ...
        auto test_data = GENERATE(test_data_t("123", 123), test_data_t("-123", -123),
                                  test_data_t("0", 0), test_data_t("+456", 456),
                                  test_data_t("0o456", 0456), test_data_t("0xA0f", 0xA0f));
...
TEST_CASE("ScalarParser_FlowPlainScalar_float") {
    ...
    SECTION("normal values: not tagged") {
        auto test_data = GENERATE(test_data_t("1.23", 1.23f), test_data_t("-1.23", -1.23f),
                                  test_data_t("0.", 0.f), test_data_t("+4.56", 4.56f),
                                  test_data_t("4.5e3", 4.5e3f), test_data_t("+4.5e3", 4.5e3f),
                                  test_data_t("-4.5e3", -4.5e3f), test_data_t("-4.5e-3", -4.5e-3f),
                                  test_data_t("4.5E3", 4.5e3f), test_data_t("+4.5E3", 4.5e3f),
                                  test_data_t("-4.5E3", -4.5e3f), test_data_t("-4.5E-3", -4.5e-3f),
                                  test_data_t("1e-1", 1e-1f), test_data_t("2E+2", 2e+2f),
                                  test_data_t("3e3", 3e3f), test_data_t("1.e3", 1.e3f),
                                  test_data_t(".1e-3", .1e-3f), test_data_t("-.1e-3", -.1e-3f),
    ...
    SECTION("infinities: not tagged") {
        auto token = GENERATE(fkyaml::detail::str_view(".inf"), fkyaml::detail::str_view("+.inf"),
                              fkyaml::detail::str_view("-.inf"), fkyaml::detail::str_view(".Inf"),
                              fkyaml::detail::str_view("+.Inf"), fkyaml::detail::str_view("-.Inf"),
                              fkyaml::detail::str_view(".INF"), fkyaml::detail::str_view("+.INF"),
    ...
    SECTION("NaNs: not tagged") {
        auto token = GENERATE(fkyaml::detail::str_view(".nan"), fkyaml::detail::str_view(".NaN"),
...
TEST_CASE("ScalarParser_FlowPlainScalar_string") {
    ...
    SECTION("plain: single line contents") {
        ...
        auto token = GENERATE(
                ...
                fkyaml::detail::str_view("1.2.3"), fkyaml::detail::str_view("foo,bar"),
                fkyaml::detail::str_view("foo[bar"), fkyaml::detail::str_view("foo]bar"),
                fkyaml::detail::str_view("foo{bar"), fkyaml::detail::str_view("foo}bar"),
                fkyaml::detail::str_view("foo:bar"), fkyaml::detail::str_view("foo bar"),
                fkyaml::detail::str_view("foo\"bar"), fkyaml::detail::str_view("foo\'s bar"),
                fkyaml::detail::str_view("foo\\bar"), fkyaml::detail::str_view("nullValue"),
                fkyaml::detail::str_view("NullValue"), fkyaml::detail::str_view("NULL_VALUE"),
                fkyaml::detail::str_view("~Value"), fkyaml::detail::str_view("trueValue"),
                fkyaml::detail::str_view("TrueValue"), fkyaml::detail::str_view("TRUE_VALUE"),
                fkyaml::detail::str_view("falseValue"), fkyaml::detail::str_view("FalseValue"),
                fkyaml::detail::str_view("FALSE_VALUE"), fkyaml::detail::str_view(".infValue"),
                ...
                fkyaml::detail::str_view("-.INF_VALUE"), fkyaml::detail::str_view(".nanValue"),
                fkyaml::detail::str_view(".NaNValue"), fkyaml::detail::str_view(".NAN_VALUE"),
    ...
    SECTION("single quoted: single line contents") {
        fkyaml::detail::lexical_token_t lex_type{
                fkyaml::detail::lexical_token_t::SINGLE_QUOTED_SCALAR};
        using test_data_t = std::pair<fkyaml::detail::str_view, std::string>;
        auto test_data =
                GENERATE(test_data_t("", ""), test_data_t("foo\"bar", "foo\"bar"),
                         test_data_t("foo bar", "foo bar"), test_data_t("foo\'\'bar", "foo\'bar"),
                         test_data_t("foo,bar", "foo,bar"), test_data_t("foo]bar", "foo]bar"),
                         test_data_t("foo}bar", "foo}bar"), test_data_t("foo\"bar", "foo\"bar"),
                         test_data_t("foo:bar", "foo:bar"), test_data_t("foo\\bar", "foo\\bar"));
    ...
    SECTION("single quoted: multiline contents") {
        fkyaml::detail::lexical_token_t lex_type{
                fkyaml::detail::lexical_token_t::SINGLE_QUOTED_SCALAR};
        using test_data_t = std::pair<fkyaml::detail::str_view, std::string>;
        auto test_data = GENERATE(test_data_t("foo\nbar", "foo bar"),
                                  test_data_t("foo \t\n \tbar", "foo bar"),
                                  test_data_t("foo\n\n \t\nbar", "foo\n\nbar"),
                                  test_data_t("\nfoo\n\n \t\nbar", " foo\n\nbar"),
                                  test_data_t("foo\nbar\n", "foo bar "),
    ...
    SECTION("double quoted: single line contents") {
        fkyaml::detail::lexical_token_t lex_type{
                fkyaml::detail::lexical_token_t::DOUBLE_QUOTED_SCALAR};
        using test_data_t = std::pair<fkyaml::detail::str_view, std::string>;
        auto test_data =
                GENERATE(test_data_t("", ""), test_data_t("foo bar", "foo bar"),
                         test_data_t("foo\tbar", "foo\tbar"), test_data_t("foo's bar", "foo's bar"),
                         test_data_t("foo:bar", "foo:bar"), test_data_t("foo,bar", "foo,bar"),
                         test_data_t("foo]bar", "foo]bar"), test_data_t("foo}bar", "foo}bar"),
    ...
    SECTION("double quoted: escaped unicode characters") {
        ...
        auto test_data = GENERATE_REF(
                test_data_t("\\x00", {to_char(0x00)}), test_data_t("\\x40", {to_char(0x40)}),
                test_data_t("\\x7F", {to_char(0x7F)}), test_data_t("\\u0000", {to_char(0x00)}),
                test_data_t("\\u0040", {to_char(0x40)}), test_data_t("\\u007F", {to_char(0x7F)}),
                ...
                test_data_t("\\U00010000",
                            {to_char(0xF0), to_char(0x90), to_char(0x80), to_char(0x80)}),
                test_data_t("\\U00080000",
                            {to_char(0xF2), to_char(0x80), to_char(0x80), to_char(0x80)}),
                test_data_t("\\U0010FFFF",
                            {to_char(0xF4), to_char(0x8F), to_char(0xBF), to_char(0xBF)}));
    ...
    SECTION("double quoted: invalid unicode escapings") {
        fkyaml::detail::lexical_token_t lex_type{
                fkyaml::detail::lexical_token_t::DOUBLE_QUOTED_SCALAR};
        auto token = GENERATE(fkyaml::detail::str_view("\\xw"), fkyaml::detail::str_view("\\x+"),
                              fkyaml::detail::str_view("\\x="), fkyaml::detail::str_view("\\x^"),
                              fkyaml::detail::str_view("\\x{"), fkyaml::detail::str_view("\\Q"));
